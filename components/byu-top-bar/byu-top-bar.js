...
.byu-header.no-nav .byu-header-menu,
.byu-header.no-nav .byu-header-menu-button {
  display: none; }
...
@media (min-width: 1024px) {
  ...
  .byu-header .byu-header-secondary .byu-header-search button {
    ...
    width: 30px;
    text-align: center; }
  .byu-header .byu-header-secondary .byu-header-user button {
    padding-right: 34px; }
  .byu-header .byu-header-secondary .byu-header-menu-button {
    display: none; }
  .byu-header .byu-header-menu {
    display: block;
    width: 100%;
    height: 32px;
    background: #ffffff; }
  .byu-header .byu-header-menu ul {
    display: flex;
    flex-direction: row;
    flex-wrap: nowrap;
    justify-content: space-between;
    ...
    margin: 0 16px;
    padding: 0; }
  .byu-header .byu-header-menu ul li {
    display: table;
    width: 16.66%; }
  .byu-header .byu-header-menu ul li.selected > * {
    background: #e5e5e5; }
  .byu-header .byu-header-menu ul li > * {
    ...
    text-align: center;
    padding: 0 6px; }
  .byu-header .byu-header-menu ul li > *:hover {
    background: #e5e5e5; } }
...
@media (max-width: 1023px) {
  .byu-header button {
    height: 100%;
    width: 140px; }
  .byu-header.no-secondary {
    height: 48px; }
  .byu-header.no-secondary .byu-header-secondary {
    display: none; }
  .byu-header .byu-header-secondary {
    background-color: #767676;
    color: #ffffff;
  ...
  .byu-header .byu-header-secondary .byu-header-user .icon {
    ...
    margin-top: -13px;
    margin-left: -13px; }
  .byu-header .byu-header-secondary.no-search > * {
    flex: 1; }
  .byu-header .byu-header-secondary.no-search > * button {
    width: 100%; }
  .byu-header .byu-header-secondary.no-search > *.byu-header-user button {
    border-left: none; }
  .byu-header .byu-header-menu {
    display: none; } }
    ...
    <div id="secondary" class="byu-header-secondary">
        ...
        <div id="menuTemplate" class="byu-header-menu-button">
            <button type="button" aria-label="Open or close menu"
                onclick="this.parentElement.parentElement.parentElement.querySelector('#navbarMenu').assignedNodes()[0].collapsed = !this.parentElement.parentElement.parentElement.querySelector('#navbarMenu').assignedNodes()[0].collapsed"	
