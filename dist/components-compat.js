...
/***/function (module, __webpack_exports__, __webpack_require__) {
    ...
    var BYUHeader = function (_HTMLElement4) {
        ...
        _createClass(BYUHeader, [{
            ...
            value: function _render() {
                ...
                if (!__WEBPACK_IMPORTED_MODULE_1_deep_equal__(state, this._renderState)) {
                    __WEBPACK_IMPORTED_MODULE_2_byu_web_component_utils__["applyTemplate"](this, 'byu-header', __WEBPACK_IMPORTED_MODULE_0__template_ejs_html__(state), function () {
                        ...
                        var userSlot = _this5.shadowRoot.querySelector("#user");
                        var userInfo = userSlot.assignedNodes();

                        var menuSlot = _this5.shadowRoot.querySelector("#navbarMenu");
                        var menu = menuSlot.assignedNodes();

                        if (userInfo.length == 0 && menu.length == 0) {
                            _this5.setAttribute('no-menu', '');
                        }

                        if (menu.length < 4) {
                            _this5.setAttribute('left-align', '');
                        }
            ...
            key: '_setItemsLeftAlign',
            value: function _setItemsLeftAlign() {}
        }, {
            key: 'mobileMaxWidth',
            get: function get() {
...
/***/function (module, exports, __webpack_require__) {
    ...
    module.exports = function anonymous(locals, escapeFn, include, rethrow) {
        ...
        __append('</style><div id="header" class="byu-header-root"><div class="byu-header-content">\n<div class="byu-header-primary">\n<img class="byu-logo" alt="BYU" src="');
