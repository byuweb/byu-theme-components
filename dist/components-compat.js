        ...
        var BYUHeader = function (_HTMLElement4) {
            ...
            _createClass(BYUHeader, [{
                ...
                value: function _addButtonListeners() {
                    ...
                    var menuButton = this._shadowRoot.querySelector('.mobile-menu-button');
                ...
                value: function _applyMenuOpen() {
                    var menu = this._shadowRoot.querySelector('#mobileMenu');
                    if (!menu) return;
                    if (this.menuOpen) {
                        menu.style.maxHeight = menu.scrollHeight + 'px';
                        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__icons_transformicons__["transform"])(this._shadowRoot.querySelector('.mobile-menu-button'));
                    } else {
                        menu.style.maxHeight = null;
                        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__icons_transformicons__["revert"])(this._shadowRoot.querySelector('.mobile-menu-button'));
                    }
                }
            }, {
