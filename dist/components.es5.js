...
(function () {
    ...
    /***/function (module, exports, __webpack_require__) {
        ...
        // module
        exports.push([module.i, ".tcon{appearance:none;border:none;cursor:pointer;display:flex;justify-content:center;align-items:center;height:1.5em;transition:.15s;user-select:none;width:1.5em;background:transparent;outline:none;-webkit-tap-highlight-color:transparent}.tcon>*{display:block}.tcon:focus,.tcon:hover{outline:none}.tcon::-moz-focus-inner{border:0}.tcon-menu__lines{width:1.5em;position:relative}.tcon-menu__lines,.tcon-menu__lines:after,.tcon-menu__lines:before{display:inline-block;height:.21429em;border-radius:.10714em;transition:.15s;background:#fff}.tcon-menu__lines:after,.tcon-menu__lines:before{width:1.5em;content:\"\";position:absolute;left:0;transform-origin:.10714em center;width:100%}.tcon-menu__lines:before{top:.375em}.tcon-menu__lines:after{top:-.375em}.tcon-transform .tcon-menu__lines{transform:scale3d(.8,.8,.8)}.tcon-menu--xbutterfly{width:auto}.tcon-menu--xbutterfly .tcon-menu__lines:after,.tcon-menu--xbutterfly .tcon-menu__lines:before{transform-origin:50% 50%;transition:top .3s ease .6s,transform .3s ease}.tcon-menu--xbutterfly.tcon-transform .tcon-menu__lines{background:transparent}.tcon-menu--xbutterfly.tcon-transform .tcon-menu__lines:after,.tcon-menu--xbutterfly.tcon-transform .tcon-menu__lines:before{top:0;transition:top .3s ease,transform .3s ease .5s;width:1.5em}.tcon-menu--xbutterfly.tcon-transform .tcon-menu__lines:before{transform:rotate(45deg)}.tcon-menu--xbutterfly.tcon-transform .tcon-menu__lines:after{transform:rotate(-45deg)}.tcon-visuallyhidden{border:0;clip:rect(0 0 0 0);height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;width:1px}.tcon-visuallyhidden:active,.tcon-visuallyhidden:focus{clip:auto;height:auto;margin:0;overflow:visible;position:static;width:auto}#mobileMenu{overflow:hidden}slot[name=actions]::slotted(*){color:#fff!important;margin-left:4px;margin-right:4px}:host([mobile-view]) slot[name=actions]::slotted(*),slot[name=actions]::slotted(*){text-decoration:none!important;font-size:13px!important;font-family:Gotham A,Gotham B,Helvetica,sans-serif!important;font-weight:400!important;text-transform:uppercase!important;cursor:pointer!important}:host([mobile-view]) slot[name=actions]::slotted(*){color:#fff!important;color:#002e5d!important;height:35px!important;display:table-cell;vertical-align:middle!important;text-align:center!important;padding:0 6px!important;display:block;width:100%;box-sizing:border-box;padding:18px 30px!important;line-height:12px;text-align:left!important;height:auto!important;background-color:#c5c5c5}:host([mobile-view])>div>*{margin-right:0}.byu-header-inner{font-family:Vitesse Book;font-size:18px}.byu-header-inner>div>*{margin-right:16px}.byu-header-inner button{background-color:#767676;color:#fff;border:none;cursor:pointer}.byu-header-inner button.mobile-menu-button{background-color:transparent;font-size:18px}.byu-header-inner .byu-header-primary{background-color:#002e5d;color:#fff;display:flex;flex-direction:row;flex-wrap:nowrap;justify-content:space-between;align-items:center;padding-left:16px;flex:1;height:55px}.byu-header-inner .byu-header-primary #title::slotted(*),.byu-header-inner .byu-header-primary .byu-header-title{white-space:nowrap;overflow:hidden;-ms-text-overflow:ellipsis;text-overflow:ellipsis;flex:1;font-family:Vitesse A,Vitesse B,Georgia,serif!important;font-size:22px;color:#fff!important}.byu-header-inner .byu-header-primary #title::slotted(*) a,.byu-header-inner .byu-header-primary .byu-header-title a{color:#fff!important}.byu-header-inner .byu-header-primary .byu-header-user button{background-color:transparent;position:relative}.byu-header-inner .byu-header-primary .byu-header-user button .icon{width:20px;height:20px;font-size:20px;vertical-align:middle}.byu-header-inner .byu-header-primary .byu-header-user button .label{font-family:Gotham A,Gotham B,Helvetica,sans-serif;font-weight:400;font-size:13px;text-transform:uppercase}.byu-header-inner .byu-header-primary .byu-header-search #search-input{font-family:Gotham A,Gotham B,Helvetica,sans-serif;font-weight:400;font-size:13px;color:#002e5d}.byu-header-inner .byu-header-primary .byu-header-search #search-input::-webkit-input-placeholder{color:#c5c5c5;opacity:1}.byu-header-inner .byu-header-primary .byu-header-search #search-input::-ms-input-placeholder{color:#c5c5c5;opacity:1}.byu-header-inner .byu-header-primary .byu-header-search #search-input::-moz-placeholder{color:#c5c5c5;opacity:1}.byu-header-inner .byu-header-primary .byu-logo{height:48px;width:92px}.byu-header-inner #mobileMenu{overflow:hidden}.byu-header-inner :host(:not([mobile-view])) .byu-header-inner{display:flex;flex-direction:row;flex-wrap:wrap;justify-content:space-between;align-items:center}.byu-header-inner :host(:not([mobile-view])) .byu-header-inner.no-nav{height:48px}.byu-header-inner :host(:not([mobile-view])) .byu-header-inner .nav-expand{display:none}.byu-header-inner :host(:not([mobile-view])) .byu-header-inner .byu-header-secondary{background-color:#002e5d;color:#fff;height:55px}.byu-header-inner :host(:not([mobile-view])) .byu-header-inner .byu-header-secondary,.byu-header-inner :host(:not([mobile-view])) .byu-header-inner .byu-header-secondary .byu-header-search{display:flex;flex-direction:row;flex-wrap:nowrap;justify-content:space-between;align-items:center}.byu-header-inner :host(:not([mobile-view])) .byu-header-inner .byu-header-secondary .byu-header-search input{border:1px solid #002e5d;border-right:none;height:20px;padding:4px 6px;flex:1;width:217px;box-sizing:content-box}.byu-header-inner :host(:not([mobile-view])) .byu-header-inner .byu-header-secondary .byu-header-search button{height:28px;width:30px;text-align:center}.byu-header-inner :host(:not([mobile-view])) .byu-header-inner .byu-header-secondary .byu-header-menu-button{display:none}", ""]);
