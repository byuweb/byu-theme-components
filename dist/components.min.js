 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const F=` ${d} `;class N{constructor(e,t,i,s){this.strings=e,this.values=t,this.type=i,this.processor=s}getHTML(){const e=this.strings.length-1;let t="",i=!1;for(let s=0;s<e;s++){const e=this.strings[s],n=e.lastIndexOf("\x3c!--");i=(n>-1||i)&&-1===e.indexOf("--\x3e",n+1);const o=G.exec(e);t+=null===o?e+(i?F:r):e.substr(0,o.index)+o[1]+o[2]+"$lit$"+o[3]+d}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,i,s){const n=t[0];if("."===n){return new w(e,t.slice(1),i).parts}if("@"===n)return[new R(e,t.slice(1),s.eventContext)];if("?"===n)return[new S(e,t.slice(1),i)];return new X(e,t,i).parts}handleTextExpression(e){return new v(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const O=(e,...t)=>new N(e,t,"html",E)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const ge={};class Ie extends ee{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(void 0===e)this._styles=[];else if(Array.isArray(e)){const t=(e,i)=>e.reduceRight((e,i)=>Array.isArray(i)?t(i,e):(e.add(i),e),i),i=t(e,new Set),s=[];i.forEach(e=>s.unshift(e)),this._styles=s}else this._styles=[e]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?ne?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==ge&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){return ge}}function de(e,t){void 0===t&&(t={});var i=t.insertAt;if(e&&"undefined"!=typeof document){var s=document.head||document.getElementsByTagName("head")[0],n=document.createElement("style");n.type="text/css","top"===i&&s.firstChild?s.insertBefore(n,s.firstChild):s.appendChild(n),n.styleSheet?n.styleSheet.cssText=e:n.appendChild(document.createTextNode(e))}}Ie.finalized=!0,Ie.render=(e,t,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const s=i.scopeName,n=z.has(t),o=M&&11===t.nodeType&&!!t.host,l=o&&!K.has(s),c=l?document.createDocumentFragment():t;if(((e,t,i)=>{let s=z.get(t);void 0===s&&(I(t,t.firstChild),z.set(t,s=new v(Object.assign({templateFactory:f},i))),s.appendInto(t)),s.setValue(e),s.commit()})(e,c,Object.assign({templateFactory:T(s)},i)),l){const e=z.get(c);z.delete(c);const i=e.value instanceof x?e.value.template:void 0;_(s,c,i),I(t,t.firstChild),t.appendChild(c),z.set(t,e)}!n&&o&&window.ShadyCSS.styleElement(t.host)};var re='/*!\n /    Copyright 2019 Brigham Young University\n /\n /    Licensed under the Apache License, Version 2.0 (the "License");\n /    you may not use this file except in compliance with the License.\n /    You may obtain a copy of the License at\n /\n /        http://www.apache.org/licenses/LICENSE-2.0\n /\n /    Unless required by applicable law or agreed to in writing, software\n /    distributed under the License is distributed on an "AS IS" BASIS,\n /    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n /    See the License for the specific language governing permissions and\n /    limitations under the License.\n / */\n/*!\n /    Copyright 2019 Brigham Young University\n /\n /    Licensed under the Apache License, Version 2.0 (the "License");\n /    you may not use this file except in compliance with the License.\n /    You may obtain a copy of the License at\n /\n /        http://www.apache.org/licenses/LICENSE-2.0\n /\n /    Unless required by applicable law or agreed to in writing, software\n /    distributed under the License is distributed on an "AS IS" BASIS,\n /    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n /    See the License for the specific language governing permissions and\n /    limitations under the License.\n / */@import https://cdn.byu.edu/theme-fonts/1.x.x/ringside/fonts.css;@import https://cdn.byu.edu/theme-fonts/1.x.x/public-sans/fonts.css;\n/*!\n /    Copyright 2019 Brigham Young University\n /\n /    Licensed under the Apache License, Version 2.0 (the "License");\n /    you may not use this file except in compliance with the License.\n /    You may obtain a copy of the License at\n /\n /        http://www.apache.org/licenses/LICENSE-2.0\n /\n /    Unless required by applicable law or agreed to in writing, software\n /    distributed under the License is distributed on an "AS IS" BASIS,\n /    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n /    See the License for the specific language governing permissions and\n /    limitations under the License.\n / */.visually-hidden{position:absolute!important;height:1px;width:1px;overflow:hidden;clip:rect(1px,1px,1px,1px)}.hidden{display:none!important}:host .byu-breadcrumbs-el ::slotted(*){opacity:.75;text-decoration:none;color:#fff;margin-right:.5em;padding-right:.75em;border-right:1px solid hsla(0,0%,100%,.25)}:host .byu-breadcrumbs-el ::slotted(:focus),:host .byu-breadcrumbs-el ::slotted(:hover){opacity:1}:host .byu-breadcrumbs-el ::slotted(:last-child){border:none}:host .byu-breadcrumbs-el.style-scope{font-size:.77778em}\n/*# sourceMappingURL=data:application/json;base64, */';de(re);let be=s([te("byu-breadcrumbs")],(function(e,t){return{F:class extends t{constructor(...t){super(...t),e(this)}},d:[{kind:"method",key:"firstUpdated",value:function(e){this.classList.add("byu-component-rendered")}},{kind:"get",static:!0,key:"styles",value:function(){return ae`${ce(re)}`}},{kind:"method",key:"render",value:function(){return O`
<nav class="byu-breadcrumbs-el">
    <slot class="byu-breadcrumbs-items"></slot>
</nav>
    `}}]}}),Ie);var ue='/*!\n /    Copyright 2019 Brigham Young University\n /\n /    Licensed under the Apache License, Version 2.0 (the "License");\n /    you may not use this file except in compliance with the License.\n /    You may obtain a copy of the License at\n /\n /        http://www.apache.org/licenses/LICENSE-2.0\n /\n /    Unless required by applicable law or agreed to in writing, software\n /    distributed under the License is distributed on an "AS IS" BASIS,\n /    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n /    See the License for the specific language governing permissions and\n /    limitations under the License.\n / */\n/*!\n /    Copyright 2019 Brigham Young University\n /\n /    Licensed under the Apache License, Version 2.0 (the "License");\n /    you may not use this file except in compliance with the License.\n /    You may obtain a copy of the License at\n /\n /        http://www.apache.org/licenses/LICENSE-2.0\n /\n /    Unless required by applicable law or agreed to in writing, software\n /    distributed under the License is distributed on an "AS IS" BASIS,\n /    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n /    See the License for the specific language governing permissions and\n /    limitations under the License.\n / */@import https://cdn.byu.edu/theme-fonts/1.x.x/ringside/fonts.css;@import https://cdn.byu.edu/theme-fonts/1.x.x/public-sans/fonts.css;:host{font-size:16px!important}:host .university-footer{background-color:#002e5d;text-align:center;font-family:Public Sans,Noto Sans,Open Sans,Helvetica,Arial,sans-serif;font-weight:700;font-size:13.8px;line-height:1.33333em;color:#fff!important;display:flex;justify-content:center;align-items:center;flex-direction:column;width:100%}:host .university-footer a{color:#fff!important;text-decoration:none}:host .university-footer a:hover{text-decoration:underline}:host .university-logo-wrapper{max-width:1200px;width:100%;padding:.25em .5em;box-sizing:border-box}:host .university-logo{font-size:1.17rem;letter-spacing:5px;font-weight:bolder;text-transform:uppercase}:host .university-info{display:flex;margin-top:.5em;flex-direction:column;align-items:center;line-height:17px}:host .privacy-notice{margin-top:.8em}:host .university-footer-gte-1440{display:none}:host .university-footer-lt-1440{display:flex;align-items:center;flex-direction:column;width:100%;padding:30px 20px;box-sizing:border-box;font-size:10px}:host .byu-link{display:block;height:2em;width:6.5em;text-decoration:none;margin-bottom:16px}@media (min-width:50rem){:host .university-footer-lt-1440{flex-direction:row}:host .byu-link{height:2.2em;width:8em;margin-bottom:0}:host .university-info{flex:auto}}@media (min-width:1024px){:host .university-footer-lt-1440{padding:30px 80px;font-size:14px;max-width:1240px;margin:0 auto}:host .university-info{flex-direction:row;margin-left:210px}:host .university-info>:not(:first-of-type){margin-top:0}:host .university-info>:not(:first-of-type):before{display:inline-block;color:#fff!important;content:"|";text-align:center;width:1em}}@media (min-width:90rem){:host .university-footer{padding:1.25em}:host .university-footer-lt-1440{display:none}:host .university-footer-gte-1440{display:block}:host .university-info{margin-left:0;margin-top:.5em}}:host .site-footer-wrapper{background-color:#fff}:host .site-footer{height:auto;box-sizing:border-box;display:flex;flex-direction:column;max-width:1240px;padding:0 20px}@media screen and (min-width:600px){:host .site-footer{flex-wrap:wrap}}:host .site-footer ::slotted(*){margin-top:30px;padding:0 40px 40px 0}:host .site-footer ::slotted(.double-wide){flex-grow:2}:host .site-footer ::slotted(.triple-wide){flex-grow:3}@media (max-width:680px){:host .site-footer::slotted{padding:0 1.25em}}@media (min-width:680px){:host .site-footer{flex-direction:row;padding:0 70px}:host .site-footer ::slotted(*){width:calc(45% - 2.5em)}:host .site-footer ::slotted(.double-wide),:host .site-footer ::slotted(.triple-wide){width:calc(100% - 2.5em)}}@media (min-width:60rem){:host .site-footer{flex-wrap:nowrap;justify-content:center}:host .site-footer ::slotted(*){width:calc(25% - 2.5em);max-width:calc(30% - 2.5em)}:host .site-footer ::slotted(.double-wide){width:calc(50% - 2.5em);max-width:calc(60% - 2.5em)}:host .site-footer ::slotted(.triple-wide){width:calc(75% - 2.5em);max-width:calc(70% - 2.5em)}}@media (min-width:90rem){:host .site-footer{margin:0 auto}:host .site-footer ::slotted(*){margin-top:60px}}\n/*# sourceMappingURL=data:application/json;base64, */';de(ue);let he=s([te("byu-footer")],(function(e,t){return{F:class extends t{constructor(...t){super(...t),e(this)}},d:[{kind:"method",key:"firstUpdated",value:function(e){this.classList.add("byu-component-rendered")}},{kind:"get",static:!0,key:"styles",value:function(){return ae`${ce(ue)}`}},{kind:"method",key:"render",value:function(){let e=new Date;return O`
...
<div class="byu-id">
    ...
    `}}]}}),Ie);export{be as BYUBreadcrumbs,he as BYUFooter,pe as BYUFooterActionButton,me as BYUFooterColumn,Ae as BYUHeader,ye as BYUMenu,Ne as BYUSearch,Le as BYUSocialMediaLinks,Ve as BYUUserInfo};
