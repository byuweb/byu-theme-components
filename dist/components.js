...
module.exports = function anonymous(locals, escapeFn, include, rethrow) {
    ...
    __append('"><div class="byu-header-title">\n<span class="super-title-wrapper title-font"><slot id="site-super-title" name="site-super-title"></slot></span>\n<span class="title-wrapper title-font"><slot id="site-title" name="site-title"></slot></span>\n<span class="sub-title-wrapper title-font"><slot id="site-sub-title" name="site-sub-title"></slot></span>\n</div>\n');
    if (locals.mobile) {
