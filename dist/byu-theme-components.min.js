 ...
 */console.log("--------------- Starting byu-theme-components 2.4.1 ---------------"),t="components.min.js",e("https://cdn.byu.edu/web-component-polyfills-v2/2.2.10"),window.WebComponents=window.WebComponents||{waitFor(e){addEventListener("WebComponentsReady",e)}},WebComponents.waitFor(()=>{!function(e){const t=new URL(e,n),o=document.createElement("script");"https:"!==t.protocol&&"localhost"!==t.hostname&&(t.protocol="https:"),o.src=t.href,o.type="module",document.head.append(o)}(t)})}();//# sourceMappingURL=byu-theme-components.min.js.map
